...
process
{
    try
    {
        ...
        $body | Add-Member -MemberType NoteProperty -Name "name" -Value ("$updatename")
        ...
        $processDetails | Add-Member -MemberType NoteProperty -Name "yamlFilename" -Value ("/.pipelines/update.yml")
